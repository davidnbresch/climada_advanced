...
% normalization of asset values for all countries
for country=unique(entity.assets.NatID)
    sel_pos = intersect(find(entity.assets.NatID==country),find(~isnan(entity.assets.Value))); % select all non-NaN assets
