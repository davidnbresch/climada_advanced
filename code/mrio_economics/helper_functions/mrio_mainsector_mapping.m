...
% 
% CALLING SEQUENCE:
%   mainsector_ids = mrio_mainsector_mapping(mainsector_names);
% EXAMPLE:
%   climada_sect_id = mrio_mainsector_mapping(climada_sect_name) 
% INPUTS:
%   mainsector_names: cell or categorical array containing mainsector names
