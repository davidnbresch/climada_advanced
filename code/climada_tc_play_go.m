...
% group 2
country_cover =[0 0 1 2 2]*1e9;
country_attach=[1 1 1 1 1]*1e9;

country_premium=[];
prob_switch=0;silent=1;climada_tc_play
fprintf('--> Q3.0 Group 2 (hist): RoE = %2.3f, max annual damage %2.3g\n',RoE_sum*100,max_annual_damage);
prob_switch=1;silent=1;climada_tc_play
fprintf('--> Q3.1 Group 2 (prob): RoE = %2.3f, max annual damage %2.3g\n',RoE_sum*100,max_annual_damage);
...
country_premium=[];
prob_switch=0;silent=1;climada_tc_play
fprintf('--> Q3.0 Group 3 (hist): RoE = %2.3f, max annual damage %2.3g\n',RoE_sum*100,max_annual_damage);
prob_switch=1;silent=1;climada_tc_play
fprintf('--> Q3.1 Group 3 (prob): RoE = %2.3f, max annual damage %2.3g\n',RoE_sum*100,max_annual_damage);
...
country_premium=[];
prob_switch=0;silent=1;climada_tc_play
fprintf('--> Q4.0 Group 1 (hist): RoE = %2.3f, max annual damage %2.3g, payout every %i year(s)\n',RoE_sum*100,max_annual_damage,payout_period);
prob_switch=1;silent=1;climada_tc_play
fprintf('--> Q4.1 Group 1 (prob): RoE = %2.3f, max annual damage %2.3g, payout every %i year(s)\n',RoE_sum*100,max_annual_damage,payout_period)

% group 2
country_cover =[0 0 2 1 2]*1e9;
country_attach=[0 0 2 1 2]*1e9;

country_premium=[];
prob_switch=0;silent=1;climada_tc_play
fprintf('--> Q4.0 Group 2 (hist): RoE = %2.3f, max annual damage %2.3g, payout every %i year(s)\n',RoE_sum*100,max_annual_damage,payout_period);
prob_switch=1;silent=1;climada_tc_play
fprintf('--> Q4.1 Group 2 (prob): RoE = %2.3f, max annual damage %2.3g, payout every %i year(s)\n',RoE_sum*100,max_annual_damage,payout_period)

% group 3
country_cover =[1 1 1 1 1]*1e9;
country_attach=[5 5 5 5 5]*1e9;

country_premium=[];
prob_switch=0;silent=1;climada_tc_play
fprintf('--> Q4.0 Group 3 (hist): RoE = %2.3f, max annual damage %2.3g, payout every %i year(s)\n',RoE_sum*100,max_annual_damage,payout_period);
prob_switch=1;silent=1;climada_tc_play
fprintf('--> Q4.1 Group 3 (prob): RoE = %2.3f, max annual damage %2.3g, payout every %i year(s)\n',RoE_sum*100,max_annual_damage,payout_period)

% group 4
country_cover =[1 1 1 1 1]*1e9;
country_attach=[1.5 1.8 2 3 3]*1e9;

country_premium=[];
prob_switch=0;silent=1;climada_tc_play
fprintf('--> Q4.0 Group 4 (hist): RoE = %2.3f, max annual damage %2.3g, payout every %i year(s)\n',RoE_sum*100,max_annual_damage,payout_period);
prob_switch=1;silent=1;climada_tc_play
fprintf('--> Q4.1 Group 4 (prob): RoE = %2.3f, max annual damage %2.3g, payout every %i year(s)\n',RoE_sum*100,max_annual_damage,payout_period)
