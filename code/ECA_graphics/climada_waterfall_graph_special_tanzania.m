...
function  fig = climada_waterfall_graph_special_tanzania(ECA_studies, case_i, digits)
...
% figure
%----------
fig        = climada_figuresize(0.5,0.25);% fig        = climada_figuresize(0.57,0.7);
...
climada_arrow([4 damage(4)], [4 residual_loss], 'width',25,'Length',25,'BaseAngle',90, 'TipAngle', 130,'EdgeColor','none', 'FaceColor',color_adaptation);
...
text_height = -adap_pot*damage(4)*0.2+residual_loss;
...
text(1-stretch, max(damage)*1.30,textstr, 'color','k','HorizontalAlignment','left','VerticalAlignment','top','FontWeight','normal','fontsize',fontsize_);
